 ...
 * calc_er.c
 *
 * Usage: calc_er [output_file_name]
 *
 ...
 *
 * 25Jun01 CDF,  A modification of phys_units.
 * v26Jun01 CDF, Added optional output file.
 *
 */
...
int main(int argc, char *argv[])
{
  ...
  if(get_valerr(&sigv,&dsigv,"velocity dispersion (km/sec)") == 0) {
    fprintf(stderr,"\nERROR.  Exiting calc_er.c\n\n");
    return 1;
  }

  /*
   * Do flat-cosmology loop, if desired.
   */

  printf("\nDo you want to loop through flat-cosmology models? [n] ");
  ...
  /*
   * Interactive loop through world models.
   */

  while(contin && !doflatloop) {
