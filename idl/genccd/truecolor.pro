pro truecolor, bfits, gfits, rfits, lsig=lsig, hsig=hsig, psfile=psfile, $
   jpfile=jpfile, imgsz=imgsz
...
if n_params() lt 2 then begin
    print, ''
    print, $
      'syntax: truecolor, bfits,gfits,rfits[,lsig=lsig,hsig=hsig,'
...
print, ''
print, 'truecolor: Reading input files:'
print, 'truecolor:   ',bfits
bim = mrdfits(bfits, 0, bhead)
print, 'truecolor:   ',gfits
gim = mrdfits(gfits, 0, ghead)
print, 'truecolor:   ',rfits
