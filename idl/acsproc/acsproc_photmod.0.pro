...
.com acsproc_photmod
combfile='SLACSJ0008-0004_10886_53984_F814W_4.fits'
maskfile='SLACSJ0008-0004_10886_53984_F814W_4_mask.fits'
  ...
  if (nvis gt 0) then begin
    ...
    for q = 0,nvis-1 do begin
      ...
      devpars = mpfit2dfun(fitfunc[0], dimg, aimg, $
        img0, 0.*img0, dspars, weights=ivar0, functargs={psf: psf, rmin: 0.1*dpix}, $
        bestnorm=bestnorm, perror=perror, niter=niter, yfit=yfit0, covar=covar, parinfo=parinfo, maxiter=10)
        
      atv,[img0-yfit0]
        
      ndof = long(total(ivar0 gt 0.)) - n_elements(devpars)
      splog, "REDUCED CHI^2 of Initial deVaucouleurs fit="+strtrim(bestnorm/ndof,2)
      yfit = img*0.
