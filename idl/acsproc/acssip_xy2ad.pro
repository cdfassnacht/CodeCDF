...
;    Added VAFACTOR correction abolton@cfa 2006july.
;   
;
;-
...
pro acssip_xy2ad, x, y, hdr, rab, decb
      ...
      vafact = sxpar(hdr, 'VAFACTOR')
      if (vafact eq 0) then begin
        splog, 'WARNING: no VAFACTOR in header!'
        vafact = 1.
      endif
      ...
      rab  = 3600.0*(xd*sxpar(hdr, 'CD1_1') + yd*sxpar(hdr,'CD1_2')) * vafact
      decb = 3600.0*(xd*sxpar(hdr, 'CD2_1') + yd*sxpar(hdr,'CD2_2')) * vafact
